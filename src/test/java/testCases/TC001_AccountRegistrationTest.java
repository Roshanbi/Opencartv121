...
public class TC001_AccountRegistrationTest extends BaseClass {
	...
	/**
	 * We need to add all the groups before and after classes, even though you
	 * extend Base class it wont trigger. In xml file we named methods thats why
	 * only look for that method
	 */
