...
public class ExtentReportManager extends BaseClass implements ITestListener {
	...
	public void onFinish(ITestContext testContext) {
		...
		// if we want to send the report to the team we can unable the below-and add
		// dependency "Apache common email"
		 ...
		 * DefaultAuthenticator("pavanoltraining@gmail.com","password")); //have to
		 * change email.setSSLOnConnect(true);
		 * email.setFrom("pavanoltraining@gmail.com"); //Sender-have to change
		 * email.setSubject("Test Results");
		 * email.setMsg("Please find Attached Report....");
		 * email.addTo("pavankumar.busyqa@gmail.com"); //Receiver-have to change (if
		 * more people distribution email will be there in project) email.attach(url,
